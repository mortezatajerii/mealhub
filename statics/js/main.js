  ...
  var imJs = {
    ...
    testimonialActivation: function () {
      ...
      $(".testimonial-item-one").slick({
        ...
        cssEase: "linear",
        prevArrow:
          '<button class="slide-arrow prev-arrow"><i class="feather-chevron-right"></i></button>',
        nextArrow:
          '<button class="slide-arrow next-arrow"><i class="feather-chevron-left"></i></button>',
        responsive: [
          {
            breakpoint: 1200,
            settings: {
...
function updateTopLayout() {
  const topbar = document.querySelector(".topbar-ad");
  ...
  const offset = topbarHeight + header.offsetHeight;
...
window.addEventListener("load", updateTopLayout);
